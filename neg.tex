...
%Yifei: Used kJ/mol for all energy units. I also convered length unit vdW radii to angstrom by looking up the data base. However the original cutoff is different for different atoms, which I didn't mention for simplicity.
\label{fig:accuracy}
\end{figure}
