...
%RZK-tensor: J. Chem. Phys. 108, 616, 1998.
%
...
%
\bea
\ket{\psi_{xi}} = \op{I}_{\bar{x}} \ket{\psi_{xi}} = \ket{\chi_{\bar{x}\mu}} {T^{\bar{x}\mu}}_{xi}
\label{eq:LMO}
\eea
%RZK: note the Latex trick to keep up-down indices aligned
%
...
% RZZK spin-polarized case in the SI, Gamma-point, replace fragment with center.
