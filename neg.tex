...
All matrix multiplications are performed with the DBCSR library~\cite{a:ls-dm-sign} designed for parallel linear-scaling handling of sparse matrices. %RZK: Update the DBCSR reference.
