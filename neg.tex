...
\begin{abstract}
% RZZK: localized molecular orbitals which are expanded in local subsets of the molecular basis set (i.e. a subset of the total molecular basis set, consisting of functions centred on or near a given atom or bond).
...
% What EPS_DEFAULT and EPS_FILTER did you use to perform timing benchmark? Yiei: EPS_DEFAULT: 1E^-12 EPS_FILTER: 1E-8
...
%RZK: references should be formatted properly
\bibliography{negref}
