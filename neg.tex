...
RZZK-Unfortunately, the computational cost of the conventional diagonalization-based KS DFT grows cubically with the number of atoms preventing its application to large systems. 
To overcome this limitation, substantial efforts have been directed to the development of linearly-scaling (LS) DFT methods~\cite{goedecker1999linear,bowler2012methods,RZK-zalesny2011linear}. 
% RZK-zalesny2011linear: R. Zalesny, M. G. Papadopoulos, P. G. Mazey and J. Leszcznski, Challenges and Advances in Computational Chemistry and Physics, Linear-Scaling Techniques in Computational Chemistry and Physics: Methods and Applications, Springer, New York, 2011.
...
%First NOLMOs: W. Adams, J. Chem. Phys., 1961, 34, 89; W. Adams, J. Chem. Phys., 1962, 37, 2009; T. Gilbert and P. Lykos, J. Chem. Phys., 1961, 34, 2199.
